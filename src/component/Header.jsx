...
const Header = React.memo(() => {
  ...
  return (
    <header className="w-full sticky top-0 z-50 bg-[#1f242d] text-white border-b border-purple-500/10">
      <div className="flex items-center justify-between px-4 md:px-6 lg:px-10 py-6">
        {/* Left Side */}
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/"
            className="text-lg font-medium hover:text-purple-400 transition-colors hidden sm:block"
          >
            Yogesh
          </Link>
        </div>
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#252d36] border-t border-purple-500/10">
